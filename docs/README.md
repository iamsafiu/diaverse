...
| [Referral Structure Rollout](runbooks/referral-structure-rollout.md) | Независимые flags, staged canary, observability и non-destructive rollback referral V1 |
...
| Referral Structure Rollout | [runbooks/referral-structure-rollout.md](runbooks/referral-structure-rollout.md) | Перед миграцией, включением любого referral flag, canary, DCR/legacy cutover или rollback |
