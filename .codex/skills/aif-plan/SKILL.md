...
cp -r .Codex/ "${WORKTREE}/.Codex/" 2>/dev/null

# AGENTS.md only if untracked
if [ -f AGENTS.md ] && ! git ls-files --error-unmatch AGENTS.md &>/dev/null; then
  cp AGENTS.md "${WORKTREE}/AGENTS.md"
fi
```
